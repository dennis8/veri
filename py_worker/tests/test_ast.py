...
""")
        ...
        module_map = {
            "modules": {"dynamic.py": {"module_name": "dynamic", "path": "dynamic.py"}}
        }
    ...
    def test_parse_file_with_syntax_error(self, temp_work_dir, sample_module_map):
        ...
        module_map = {
            "modules": {
                "bad_syntax.py": {"module_name": "bad_syntax", "path": "bad_syntax.py"}
            }
        }
        ...
        edges_from_bad = [
            e for e in imports_graph["edges"] if e["from_module"] == "bad_syntax"
        ]
